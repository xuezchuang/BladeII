...
{
	EResurrectType_OnlyClientMode = 0,		// 努扼捞攫飘俊辑父 何劝窍绰 葛靛  (痢飞傈)
	EResurrectType_Stage = 1,				// 胶抛捞瘤 何劝葛靛				 (Default, Stage)
	EResurrectType_Raid = 2,				// 饭捞靛 何劝葛靛 鸥涝			 (Raid)
	EResurrectType_Max,
};
...
{
	//int32 stage_idx; //stage_idx绰 TMap狼 虐肺 荤侩吝
	int32 Iteminfo_idx;
	int32 Min_Gain;
	int32 Max_Gain;
	int32 Rate;
...
public:
	...
	FORCEINLINE int32 GetMaxBoostCount() { return 0;	/*3硅 葛氰 捞侩鼻 馆康俊 蝶弗 烙矫 荐沥*/ };
