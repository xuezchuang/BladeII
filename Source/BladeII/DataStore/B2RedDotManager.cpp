...
bool FB2RedDotManager::HasLobbyRedDot_Dungeon_Counter()
{
	...
	// 拌沥 积己矫 -1肺 (RequestGetCounterDungeon) 夸没 傈鳖瘤 甸绢坷哥 扼捞宏 辑厚胶 矫 官肺 馆拜带傈捞 坷锹登瘤 臼阑 巴 鞍栏聪 捞绰 Tutorial捞尔 楷拌 啊瓷己阑 积阿秦具窃
...
{
	// 秦寸 mail count肺 眠饶 Header俊 Unread Mail Count 钎矫 秦拎具 窃
	if (CurrentRedDotState.get() != nullptr)
	{
