...
{
	ViewCenterCamera,			// 중앙에 카메라놓기
	ViewSanctuaryBottomCamera,	// 하단 성소 카메라놓기
	ViewSanctuaryTopCamera,		// 상단 성소 카메라놓기
	ViewIngameCamera,			// 카메라만 인게임으로 복구
	SetIngame,			// 끝 복구
};
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Timer)
	float WaitActiveTime;		// 거점 활성화 대기
...
private:
	...
	// 성소 마신자 정보. 키는 성소아이디 값은 먹은자 넷아이디
