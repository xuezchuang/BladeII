...
static const uint32 PEER_NETSTANDALONE	=	3; //정상적으로 대전이 이루어졌지만 상대가 떠나서 AI와 대결하는 상태
static const uint32 PEER_STANDALONE		=	4; //시작부터 AI와 대전
...
//	virtual void HandleHealingHealth(AActor*); //일단 TakeDamage에 실어 보내자. 잘 안되면 Packet을 만들어서 따로 보내자
...
private:
	...
	// NetId별로 마지막에 받은 SyncedAnimStateIndex저장
	// 미스폰 케릭에 대한 내용일경우 대비. ABladeIINetPlayer::BeginPlay()에서 본인아이디꺼 갖다씀
