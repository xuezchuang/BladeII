...
namespace Utilities
{
	...
	private:
		...
		ESessionCloseReason SessionCloseReason;//ServiceNotAvailableEvent啊 惯积 傈俊 Disconnect 捞蜡啊 乐阑锭 蔼阑 持绢淋(ex>吝汗 立加)
	};
...
struct FItemGradeInfo
{
	...
	static CONSTEXPR int32 MINIMUM_ADVANCED_SURPASS_STAR_GRADE = 11;	// 11己 捞惑篮 11己 捞惑狼 厘厚甸父阑 檬岿 且 荐 乐促.
	static CONSTEXPR int32 MINIMUM_ADVANCED_UPGRADE_STAR_GRADE = 10;	// 惑困 铰鞭籍捞 鞘夸肺 窍绰 厘厚 己
