...
private:
	...
	TWeakObjectPtr<UB2RichTextBlock> TB_LimitStartTime;	//기간 제한 제작 시작시간
	TWeakObjectPtr<UB2RichTextBlock> TB_LimitEndTime;	//기간 제한 제작 종료시간
...
private:
	...
	//이게 4개로 고정된 이유는 서버쪽에서 4개로 고정해 버렸기 때문
	...
	int32 quantity;
	int32 maxQuantity;	//최상단에 define된것 말고 가진 인벤토리 안에서 가능한 최대 갯수
	int32 resultIndex;
	int32 refundIndex;
