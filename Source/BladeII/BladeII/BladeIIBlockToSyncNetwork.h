...
//	//사실 Resopone도 Session이 끊긴 거지만 
//	//Resopone를 못받는 것과 Session Disconnect가 조금 다른 의미로 쓰이기 때문에 분리
...
//	void SessionDisconnetFromServer(int32 _reasonCode); //이 결과코드는 위의 에러코드와는 다른 에러코드 임
//	void Retry();
//	void GoToTitle();
