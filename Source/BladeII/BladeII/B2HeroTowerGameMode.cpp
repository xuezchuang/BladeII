...
void AB2HeroTowerGameMode::NotifyPlayerDeadEnd(class ABladeIIPlayer* DeadPlayer)
{
	...
	if (!(StageManager && StageManager->IsStageCleared())) // 菩硅 皋春甫 凯霸 登绰单 胶抛捞瘤 努府绢 捞饶俊绰 累悼窍瘤 臼霸..
	{
		PlayBGMByCommonSoundID(ECommonSoundID::ECSID_BGM_CombatDefeat); // 父老 磷绰 官肺 弊 矫痢何磐 敲饭捞 秦具 茄促搁 DeadEnd 啊 酒囱 OnDeath 鞍篮 镑俊辑.. 
