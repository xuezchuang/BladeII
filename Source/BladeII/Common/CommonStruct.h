...
{
	ECSA_NormalPoint,				// 扁夯
	ECSA_IntrinsicOptions,			// 绊蜡 可记
	ECSA_RandomOptions,			// 罚待 可记
	ECSA_SealOption,				//阿己可记
	ECSA_WingNormalOption,			// 朝俺 扁夯
	ECSA_WingAdditionalOption,		// 朝俺 眠啊 可记
	ECSA_RankPromotion,			// 柳鞭
	ECSA_SkillOption,				// 胶懦可记
	ECSA_ItemSetEffect,			// 酒捞袍 技飘 瓤苞	(%)
	ECSA_EnhanceSetEffect,			// 碍拳 技飘 瓤苞	(%)
	ECSA_RelicOption,			// 绊措蜡拱 可记
	ECSA_EtherOption,			// 俊抛福 可记
	ECSA_GuildOption,			// 辨靛 可记(滚橇) (%)
	ECSA_FairyOption,			// 其绢府 可记
	ECSA_TotemSmeltOptions,		// 力访 焊呈胶
	ECSA_End
};
...
struct FB2Item
{
	...
	//俊抛福甫 item栏肺 函券 (胶抛捞瘤 裙垫包访俊辑父 荤侩秦具 茄促!!!)
	...
	* Each digit can have defined information, check DevOnlyGet**FromRefID functions below. Client does not need to know that.. Just for a convenience.. */
	...
	ECostumeEquipPlace CostumeEquipPlace; //内胶片 馒侩 困摹
...
//================================================================================================================================================
// Note :	FServerStageID
//			ClientStageId(int32)客 鸥涝阑 疙犬窍霸 窍扁困秦辑 货肺款 鸥涝阑 沥狼 (笛促 int32肺 登绢乐栏搁 内靛惑 角荐啊 腹阑荐 乐促)
//			鸥涝阑 疙犬洒 备盒窍扁困秦 explicit 荤侩(哗瘤富巴..) / 楷魂篮 祈窍霸 荤侩窍扁困秦 楷魂磊 犁沥狼
//================================================================================================================================================
//			ClientStageId : 胶抛捞瘤 酒捞叼甫 唱鸥晨 (10 : 胶抛捞瘤 10)
//			ServerStageId : ClientStageID + (抄捞档 * 1000) (2010 : 抄捞档 2狼 胶抛捞瘤 10)
//================================================================================================================================================
//	林狼(spivy) :  ServerStageId 拌魂过篮 辑滚俊辑 窍绰 蔼栏肺 眠饶俊 惑炔俊 蝶扼 函版瞪 荐档 乐栏聪 努扼俊急 蝶肺 拌魂窍瘤富绊, 辑滚俊辑 林绰蔼栏肺 魄窜且巴
//				   explicit阑 窍扁困茄 侩档狼 努贰胶捞骨肺 虐况靛 哗瘤富巴!!
//================================================================================================================================================
struct FServerStageID
{
	int32 Id;	// ServerStageId : 2010 (=> 2(抄捞档)*1000 + 10(努扼捞攫飘 胶抛捞瘤 逞滚)) (葛电 拌魂过篮 辑滚俊辑~)
...
{
	None,
	WaitingAccept,	// 檬措 惯脚磊 ( 惑措 荐遏 措扁 )
	WaitingDecision,// 檬措 荐脚磊 ( 荐遏/芭例 滚瓢 措扁 )
	Success
};
...
FORCEINLINE EB2GameMode InvitationTypeToGameMode(int32 InvitationType)
{
	...
	{
	case 1: return EB2GameMode::PVP_Tag;	// 酒流 b2network 鸥涝 沥秦瘤瘤 臼澜 - 箭磊 1 官牢爹
	}
...
{
	// ECharStatApplyType俊 蝶弗 PrimaryPoint蔼阑 啊瘤绊乐绰促.
	// 角力肺 利侩登绰 弥辆蔼篮 GetEffectiveOptionValueTempl(...)栏肺 搬沥
	...
	// 扁粮 矫胶袍阑 弥措茄 蜡瘤茄促.
	// 父距 配袍 寇俊 厘厚俊 皑家 可记阑 持绊 酵促搁 秦寸 何盒狼 可记 火涝何甫 茫酒啊
	// AddPrimaryPointValue(ECharStatApplyType InApplyType, float InValue) -> AddPrimaryPointValue(ECharStatApplyType InApplyType, FOptionValue InValue) 肺 官层霖促.
	...
	bool PreCalculateCharApplyType(TOptionTypeEnum InOptionType, ECharStatApplyType InApplyType)
	{
		...
		// GetEffectiveOptionValueTempl 甫 烹秦 固府 拌魂登绢 唱柯 蔼篮 Source 肺 甸绢埃 蔼甸牢 RawValue 屈侥捞 酒聪扁 锭巩俊
		// 促矫 拌魂 侥栏肺 甸绢啊扁 困秦 RawValue 屈侥栏肺 官层林绰 例瞒甫 啊笼聪促.
...
enum class EUpgradeded : uint8 // 绢恫 铰鞭籍阑 荤侩秦具登绰瘤 可记侩
{
	UPGRADE_BEFORE = 0,		// 铰鞭傈俊 眉农且 版快
	UPGRADE_AFTER,			// 铰鞭饶俊 眉农且 版快
	UPGRADE_NONE,			// 可记 鞘夸 绝阑 版快
};
/**
...
{
	Success = 200,	// 己傍
	ExceedMonthlyUsage = 7001, // 岿埃 倾侩 荤侩樊 檬苞
	ExceedDailyUsage = 7002, // 老埃 倾侩 荤侩樊 檬苞
	SettingDisabled = 7101, // 荐脚 瞒窜 惑怕
	NotKakaoTalkUser = 7202, // 墨墨坷佩 蜡历 酒丛
	Error = 9999,	// 葛电 俊矾
};
