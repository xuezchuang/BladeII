...
{
	Invitable,				// 檬措啊瓷
	OpenInviteUI,			// 檬措 扑诀 坷锹
	SearchingQuickJoin,		// 狐弗八祸吝
	JoinCharacter,			// 颇萍钦幅
	Max,					//
};
...
public:
	...
	bool	IsEmpty();
	void	ClearRaidJoinData();		// RaidJoin 包访 单捞磐甫 檬扁拳 茄促. (浇吩单捞磐, 檬措罐篮 RoomId)
	...
	// ==================== InGame UI (0锅 牢郸胶 : 郴 某腐磐 单捞磐 (林狼 : DocBattle俊辑 吝汗栏肺 包府窍绰 单捞磐绰 公矫)
