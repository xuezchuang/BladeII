...
void UB2UIMsgPopupTooltipSkillOption::SetSkillID(int32 SkillId)
{
	...
	if (AllSkillInfo)
	{
		// LoadSynchronous 甫 窍妨聪 const 甫 绝局具..
...
void UB2UIMsgPopupTooltipSkillOption::SetMercenarySpecialSKillID(int32 InSkillID, int32 InLv, ENPCSpecialSKill InSkillType)
{
	...
	b2network::B2mdGuildMercenaryMasteryPtr MercenaryMasteries = GuildMasterData.GetMercenaryMasteries(InSkillID, InLv);	//饭骇诀困茄版氰摹, 傈巩拳扁贱 构乐唱 啊廉坷扁
