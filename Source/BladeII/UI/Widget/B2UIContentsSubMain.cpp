...
{
	LobbyEnterHeroMgmtModeClass<EHeroMgmtSubMode>::GetInstance().Signal(EHeroMgmtSubMode::EHMSM_Skill); // GameMode 率 脚龋
}

void UB2UIContensSubMain::GotoBrevetScene()
{
	LobbyEnterHeroMgmtModeClass<EHeroMgmtSubMode>::GetInstance().Signal(EHeroMgmtSubMode::EHMSM_Brevet); // GameMode 率 脚龋
}

void UB2UIContensSubMain::GotoWingScene()
{
	LobbyEnterHeroMgmtModeClass<EHeroMgmtSubMode>::GetInstance().Signal(EHeroMgmtSubMode::EHMSM_Wing); // GameMode 率 脚龋
}

void UB2UIContensSubMain::GotoConstantheroScene()
{
	LobbyEnterHeroMgmtModeClass<EHeroMgmtSubMode>::GetInstance().Signal(EHeroMgmtSubMode::EHMSM_Relic); // GameMode 率 脚龋
