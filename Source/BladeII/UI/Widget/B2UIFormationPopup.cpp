...
void UB2UIFormationPopup::UpdateStaticText()
{
	...
	{
		TB_Descrition->SetText(BladeIIGetLOCText(B2LOC_CAT_GENERAL, TEXT("Teamformation_UpgradeQuestion"))); //柳屈阑 碍拳窍矫摆嚼聪鳖?
	}
	...
	{
		TB_Cancle->SetText(BladeIIGetLOCText(B2LOC_CAT_GENERAL, TEXT("Teamformation_Cancel"))); //秒家
	}
}
