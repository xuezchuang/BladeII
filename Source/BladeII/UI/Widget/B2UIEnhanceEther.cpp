...
void UB2UIEnhanceEther::UpdateStaticText()
{
	...
	{
		X_TB_TItle->SetText(BladeIIGetLOCText(FString(B2LOC_CAT_ETHER), FString(TEXT("Ether_Enhancement_Title")))); //俊抛福 碍拳
	}
}
...
{
	if (IsEnhanceSuccess == true) // 碍拳 己傍
	{
...
//	//if (EnhanceEther)
//	//{
//	//	if (InSubOptionState == 1) // 眠啊
//	//	{
//	//		return EnhanceEther->SubOption.Num() - 1;
//	//	}
//	//	else if (InSubOptionState == 2) // 碍拳
//	//	{
//	//		for (int i = 0; i < EnhanceEther->SubOption.Num(); ++i)
//	//		{
