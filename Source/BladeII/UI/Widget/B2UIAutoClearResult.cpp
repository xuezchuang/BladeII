...
void UB2UIAutoClearResult::SubscribeEvents()
{
	...
	//LevelupFinishDelegate 拌加 瘤况辑 荤侩窍扁 塞惦..
...
void UB2UIAutoClearResult::GetResultItemInfo(OUT TArray<FB2Item>& ResultItems, const FB2SweepStageInfo& InSweepStageinfo)
{
	...
	//int32 GoldBuffRate = GET_TUPLE_DATA(FB2ResponseSweepStage::gold_buff_rate_index, InSweepStageinfo);// 侵鸥烙 榜靛 滚橇 刘啊啦(欺季飘)
	...
	//		RewardGoldItem.SetPrimaryPoint((int32)GoldSum); // 抗傈俊 PrimaryPoint 肺 敬 霸 乐绢辑..
