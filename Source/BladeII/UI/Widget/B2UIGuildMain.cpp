...
void UB2UIGuildMain::SetGuildMain(EGuildInfoType type, const FGuildInfo& GuildInfo)
{
	...
	//UIP_GuildRewardBoxProgress->SetVisibility(ESlateVisibility::Hidden);//CBT 烙矫 阜酒初扁woong
...
void UB2UIGuildMain::SetGuildInfo(const FB2ResponseGuildInfoPtr GuildInfo)
{
	...
	if (RTB_WinCount.IsValid())
	{
		...
		RTB_WinCount->SetText(FText::Format(BladeIIGetLOCText(B2LOC_CAT_GENERAL, TEXT("Guild_BattleStatistics_WinCount")), WinCountText));			//眠饶俊 辑滚 肯己登搁 促矫 利侩
	}
...
void UB2UIGuildMain::SetGuildBattleCurrentState()
{
	...
	if (TB_GuildBattleState.IsValid())									//woong
	{
		...
		{
		case b2network::B2GuildBattleStateType::NONE:					//蜡历啊 绒侥惑怕肺 舅绊乐绰惑怕
		...
		case b2network::B2GuildBattleStateType::INITDONE:
			...
			break;		
		case b2network::B2GuildBattleStateType::READY:					//辨靛脚没 惑怕
			...
			break;
		case b2network::B2GuildBattleStateType::MATCHING:				//概莫吝老锭
		case b2network::B2GuildBattleStateType::MATCHINGDONE:
			...
			break;
		case b2network::B2GuildBattleStateType::BATTLE:					//辨靛傈 扁埃
			TB_GuildBattleState->SetText(BladeIIGetLOCText(B2LOC_CAT_GENERAL, TEXT("Guild_BattleState")));
			break;
		case b2network::B2GuildBattleStateType::SETTLEMENT:				//沥魂扁埃
		case b2network::B2GuildBattleStateType::SETTLEMENTDONE:
			...
			break;
		case b2network::B2GuildBattleStateType::RESULT:					//焊惑罐阑荐 乐绰惑怕
...
void UB2UIGuildMain::SetRewardBoxProgress()
{
	...
	if (UIP_GuildRewardBoxProgress.IsValid())
	{
		...
		//辨靛焊惑捞 霉锅掳惑磊啊 酒聪绊 焊惑阑 罐阑荐 乐绰 惑怕啊 酒聪绊 焊惑罐阑荐乐绰 辨靛惑怕老锭 罐篮吧肺 钎矫 酒 呈公 汗棱窍备唱 ばば
