...
void UB2UIAttendanceMain::Init()
{
	...
	{
		/* 扁裙 夸没捞 免籍阑 促 罐栏搁 霸烙阑 犁矫累 窍扁傈鳖瘤 徘阑 劝己拳 矫难崔扼绊 沁扁 锭巩俊 溜矫 摧扁 困秦辑绰
		FClientDataStore::SetNewUserAttendanceInfo 俊辑 IsNewUserAttendance阑 荐沥
		*/
		// 立加 且 锭 免籍 啊瓷老荐啊 乐菌绰啊(免籍 芒阑 虐绰 矫痢捞 酒聪扼 立加矫痢牢 捞蜡绰 扁裙狼档)
...
{
	// cbt侩 炼扒 // CBT & 老馆 免籍老锭绰->捞亥飘 免籍栏肺(捞亥飘 免籍捞 蜡瓤且锭)
	...
	// eIndex眉农 饶 蜡瓤窍瘤 臼阑锭 泅犁 蜡瓤茄徘阑 GetAvailableTab()俊辑 馆券
