...
void UB2UISummonItem::CacheAssets()
{
	...
	// 悼利 积己窍绰 扑诀甸篮 CanvasPanel 父 掘绢滴绊 角力 积己篮 捞饶 on-demand 肺
...
{
	// 捞霸 积己等 惑怕俊辑 阂妨具 窍绰 芭
	checkSlow(CreatedUIP_CharSelectPopup);

	// 酒付档 某腐磐寸 窍唱究老 芭 鞍篮单.. 瘤陛 捞扒 葛滴 悼老茄 啊拜捞扼绰 啊沥牢扒啊
