...
bool UB2UILobbyBanner::CheckImageSize(class UTexture2DDynamic* Tex)
{
	...
	if (TotalAddedTextureSizeInfo.GetTotalMemoryBytes() > 64 * 1024) // 荤捞令啊 呈公 农促搁 捞固瘤甫 措眉
	{ 
#if BII_SHIPPING_ALLOWED_DEV_FEATURE_LV2 && WITH_BII_ON_SCREEN_DEBUG_TEXT // 郴何 呼靛俊辑绰 焊促 磊技茄 郴侩阑 叼胶敲饭捞.
