...
void UB2UIRankerInfo::CacheAssets()
{
	...
	//[@AKI, 170420] M16 일대일&팀대전개선 p.27 영웅 레벨 삭제로 인해 Visibility 변경
	// TB_PlayerLevel을 다 지워버려도 되는데...혹시 몰라서 남겨 놓음
...
void UB2UIRankerInfo::SetRankerInfo(const FModRankerInfo& RankerInfo,bool bNotResult)
{
	...
	//[@AKI, 170420] M16 일대일&팀대전개선 p.27 영웅 레벨 삭제로 인해 주석 처리
//	if (TB_PlayerLevel.IsValid()) //유저레벨개념.
