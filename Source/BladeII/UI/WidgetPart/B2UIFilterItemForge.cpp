...
void UB2UIFilterItemForge::CacheAssets()
{
	...
	const int32 GradeFilterCount = VisibleMaxStarGrade - MinGradeFilter + 1+ ApplyAllAtStarGrade; // ex) 1何磐8鳖瘤搁 MinGradeFilter = 1, VisibleMaxStarGrade = 8 ( 8 - 1 + 1 +1) 8俺+ 傈盲
...
void UB2UIFilterItemForge::GetSelectedFilters(TArray<EItemInvenType>& OutInvenTypeFilter, TArray<int32>& OutStarGradeFilter, bool checkAllBox)
{
	...
	if (checkAllBox == false)
	{
		...
		else
		{
			...
			//公郊 滚弊牢瘤 隔扼档 酒捞袍阑 Consumables啊 酒囱 End肺 牢侥秦辑 End肺 沥窃.
...
//////////////////////////////////////////////////////////////////////////
//	眉农冠胶狼 惑怕啊 官差菌阑锭 龋免窍绰 捞亥飘绰 喉风橇赴飘俊 窍靛内爹 登绢乐澜.
//////////////////////////////////////////////////////////////////////////
