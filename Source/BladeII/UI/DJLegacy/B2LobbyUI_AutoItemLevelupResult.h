...
#include "B2LobbyUI_AutoItemLevelupResult.generated.h"

UCLASS()
class BLADEII_API UB2LobbyUI_AutoItemLevelupResult : public UB2LobbyUserWidget
{
	GENERATED_BODY()
...
public:
	...
	UB2LobbyUI_AutoItemLevelupResult(const FObjectInitializer& ObjectInitializer);
