...
{
	NO_CANCEL		UMETA(DisplayName = "NoCancel"),	//眉牢瘤矫 葛电 楷免阑 沥惑利栏肺 秦霖促.
	CANCEL_CLOSE	UMETA(DisplayName = "CancelClose"),	//眉牢瘤矫 努肺令 楷免父 久绰促.
	CANCEL_OPEN		UMETA(DisplayName = "CancelOpen"),	//眉牢瘤矫 坷锹 楷免父 久绰促.
	CANCEL_ALL		UMETA(DisplayName = "CancelAll"),	//眉牢瘤矫 葛电 楷免阑 久绰促.
	PREOPEN			UMETA(DisplayName = "Preopen"),		//眉牢瘤矫 促澜俊 躲 UI甫 固府 剁况初绰促. 付摹 扑诀牢芭 付成
};
...
{
	First			UMETA(DisplayName = "First"),		//梅栏肺(First)
	Forward			UMETA(DisplayName = "Forward"),		//菊栏肺(Next)
	Reverse			UMETA(DisplayName = "Reverse"),		//第肺(Prev)
	End				UMETA(DisplayName = "End"),			//场栏肺(End)
};
