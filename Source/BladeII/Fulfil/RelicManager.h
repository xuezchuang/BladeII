...
//ENum 鉴辑啊 狼固啊 乐澜. M18俊 绊措蜡拱 府春倔俊 绊措蜡拱 沥府甫 曼绊窍搁 辑滚 ID客 概莫 凳.
//鉴辑甫 官曹扼搁 辑滚尔 刚历 嘎苗具 窃.
enum EApplyMode : uint8
{
	EApplyMode_None,
	EApplyMode_HeroTower	= 1,
	EApplyMode_PVP_Tag		= 2,
	EApplyMode_Control		= 3, //评 痢飞傈牢单....
	EApplyMode_Raid			= 4,
	EApplyMode_PVP_Team		= 5,
	EApplyMode_Guild		= 6,
	//EApplyMode_Assault, //档傈狼 啪
	EApplyMode_Total,
	//Total焊促 农搁 GetPC(Attack)(Defence)(Health)ByMod俊辑 return窃栏肺
	//荤侩矫 咯扁辑 Total焊促 困肺 棵副巴
	//EApplyMode_Scenario,
