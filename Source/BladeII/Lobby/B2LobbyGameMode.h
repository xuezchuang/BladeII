...
struct FLobbyMatchPeerInfo
{
	...
	bool		IsReady;
	EPCClass	ReservedPCClass;	// 急琶等 某腐磐甫 悼扁拳
	ETeamType	PlayerTeamType;		// 鞘夸窍搁 评备盒
};
...
bool IsHeroMgmtMode() const;
	...
	//[@AKI, 170613] 距 匙飘况农俊辑 肺厚俊辑父 Disconnect甫 秦崔扼绊 夸没秦辑 父电 啊惑 皋家靛
	//鞘夸茄 葛靛俊辑绰 坷滚扼捞靛 秦辑 荤侩窍搁 登绊 酒聪搁 BladeIIGameMode俊辑 false甫 return 窃
