...
{
//	TArray<UActorComponent*> CompsByClass = GetComponentsByClass(UTextRenderComponent::StaticClass());
	//auto CompsByClass = GetComponentsByClass(UTextRenderComponent::StaticClass());
